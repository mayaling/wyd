        ...
        },
        {
            ...
            children: [{
                ...
                },
                {
                    ...
                    path: '/goods',
                    component: resolve => require(['../components/page/app/goods.vue'], resolve),
                    meta: { title: '版本管理', admin: true }
                },
                {
                    path: '/editgoods',
                    component: resolve => require(['../components/page/app/editgoods.vue'], resolve),
                    meta: { title: '版本管理', admin: true }
                },
                {
                    path: '/order',
                    component: resolve => require(['../components/page/app/order.vue'], resolve),
                    meta: { title: '版本管理', admin: true }
                },{
                    path: '/editorder',
                    component: resolve => require(['../components/page/app/editorder.vue'], resolve),
                    meta: { title: '版本管理', admin: true }
                },
                {
                    path: '/logistics',
                    component: resolve => require(['../components/page/app/logistics.vue'], resolve),
                    meta: { title: '版本管理', admin: true }
                },{
                    path: '/editlogistics',
                    component: resolve => require(['../components/page/app/editlogistics.vue'], resolve),
                    meta: { title: '版本管理', admin: true }
                },
                {
                    path: '/wymbanner',
                    component: resolve => require(['../components/page/app/wymbanner.vue'], resolve),
                    meta: { title: '无忧米banner', admin: true }
                },{
                    path: '/editwymbanner',
                    component: resolve => require(['../components/page/app/editwymbanner.vue'], resolve),
                    meta: { title: '无忧米banner', admin: true }
                },
                {
                    path: '/menumanagement',
